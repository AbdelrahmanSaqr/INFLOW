...
import classes from "./Headerguest.module.css";
...
//             {/* logo */}
//             <Container>
//                 <Navbar.Brand className={classes.logo} ><img src={Logo} alt="Logo" /></Navbar.Brand>
//             </Container>
            
//             {/* middle items (home & contact us & find coach)  */}
//             <Container className={classes.leftnavbar}>
//                 <Nav.Link className={classes.home} >
                    
//                     Home
//                 </Nav.Link>

//                 <Nav.Link className={classes.contactus}>
                   
//                     Contact us
//                 </Nav.Link>
                
//                 <Nav.Link className={classes.ourteam}>
                    
//                     Find coach
//                 </Nav.Link>
//             </Container>

//             {/* left items (language & login btn & create acc btn ) */}
//             <Container className={classes.rightnavbar}>
//                 <div>
