...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        if ($request['type'] == 'patient') {
            Patient::create([
                'user_id' => $id,
                'original_city' => $request->orignal_city,
        ...
        return response()->json("You are not patient", 401);
    }
    ...
    {
        return $this->createNewToken(auth::refresh(), null);
    }
