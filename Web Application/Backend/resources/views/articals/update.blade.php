            ...
            <div class="row mb-2" style="margin-left: 15">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Articles / Update Article</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('artical.update', $artical->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{-- Title & Body --}}
                    <div class="row mb-3 d-flex justify-content-center">
                        <div class="col-md-8 pb-2">
                            <label class="form-label" for="inputTitle">Title</label>
                            <input type="text" name="title" class="form-control" value="{{ $artical->title }}" id="inputTitle">
                        </div>
                        <div class=" col-md-8 form-group">
                            <label class="form-label" for="ControlTextarea1">Body</label>
                            <textarea class="form-control" name="body" id="ControlTextarea1" rows="3">{{ $artical->body }}</textarea>
                        </div>
                        <div class=" col-md-8 form-group">
                            <label class="form-label" for="Controldes">Description</label>
                            <textarea class="form-control" name="description" id="Controldes" rows="2">{{ $artical->description }}</textarea>
                        </div>
                    </div>
                    {{-- img --}}
                    <div class="row mb-3 d-flex justify-content-center">
                        <div class="col-md-5 d-flex justify-content-center">
                            <div class="col-md-6">
                                ...
                                <input class="" id="inImg" name="img" value="{{ $artical->img }}" type="file" />
                            </div>
                        </div>
                        <div class="col-md-5">
                            <img style="height: 150px" id="image" src="{{ URL::asset($artical->img) }}">
                        </div>
                    </div>
